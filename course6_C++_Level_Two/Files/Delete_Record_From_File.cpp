...
int main(){
    ...
    cout << "File Content Before Deleting The Record:" << endl;
    PrintFileContent("f:/Programing/C++/ProgramingAdvices/course-6/myfile.cpp");

    
    deleteRecordFromFile("f:/Programing/C++/ProgramingAdvices/course-6/myfile.cpp", "ali");
    
    
    cout << "File Content After Deleting The Record:" << endl;
    PrintFileContent("f:/Programing/C++/ProgramingAdvices/course-6/myfile.cpp");
